...
microbiota (ref), we hypothesized the different \emph{C. difficile}
...
similar microbial communities due to copraphagy (ref), we tried to
...
histopathology (20) and found there was no difference in cecum and colon
...
(ref). We also looked at 6 days post-infection because that was when we
