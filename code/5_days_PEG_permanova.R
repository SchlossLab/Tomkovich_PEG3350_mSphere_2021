...
five_d_stools_adonis <- adonis(five_d_stools~(group/(unique_cage_no*ext_plate))*day, strata = five_d_stools_variables$unique_mouse_id, data = five_d_stools_variables, permutations = 10, parallel = 10)
