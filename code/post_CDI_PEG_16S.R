...
save_plot("results/figures/post_CDI_PEG_shannon.png", shannon_post_cdi_peg)
...
save_plot("results/figures/post_CDI_PEG_shannon_overtime.png", shannon_post_cdi_peg_overtime_full)
