...
post_stools_adonis <- adonis(post_stools~day*(group/(unique_cage_no*ext_plate)), strata = post_stools_variables$unique_mouse_id, data = post_stools_variables, permutations = 10, parallel = 10)
