...
post_stools_adonis <- adonis(post_stools~(group/(unique_cage_no*ext_plate*exp_num))*day, strata = post_stools_variables$unique_mouse_id, data = post_stools_variables, permutations = 1000, parallel = 10)
